...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public void logar() {
        ...
        try {
            ...
            if (rs.next()) {
                //a linha abaixo obtem o conteudo do campo perfil da tabela tblUsuario
    ...
    public TelaLogin() {
        ...
        if (conexao != null) {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/database_green.png")));
        } else {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/database_red.png")));
        }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(436, 205));
